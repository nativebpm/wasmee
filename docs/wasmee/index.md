...
| [WASMEE-108](file:///Users/user/gitlab.com/wasmee/wasmee/docs/wasmee/WASMEE-108/WASMEE-108.md) | Go-Module Style WASM Integration | In Progress | Implement a robust and native Go-module packaging pattern using go:embed for WASM modules. |
