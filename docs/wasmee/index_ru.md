...
| [WASMEE-102](file:///Users/user/gitlab.com/wasmee/wasmee/docs/wasmee/WASMEE-102/WASMEE-102.md) | Перевод рантайма в Stateless | В процессе | Рефакторинг Wasmee с удалением глобального слоя персистентности RustStore для превращения в stateless-вычислитель. |
