...
| [WASMEE-108](file:///Users/user/gitlab.com/wasmee/wasmee/docs/wasmee/WASMEE-108/WASMEE-108.md) | Интеграция WASM-модулей в стиле Go-модулей | В процессе | Реализация надежного и нативного паттерна упаковки гостевых модулей WASM с использованием go:embed. |
